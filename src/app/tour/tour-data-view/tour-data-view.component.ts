...
import * as TourData from 'src/app/content/tour.data-view.json';
import { HelperService } from 'src/app/services/helper/helper.service';
const TourContent = (<any>TourData).data;

@Component({
  selector: 'oc-tour-data-view',
  templateUrl: './tour-data-view.component.html',
  styleUrls: ['./tour-data-view.component.css']
})
export class TourDataViewComponent implements OnInit {
