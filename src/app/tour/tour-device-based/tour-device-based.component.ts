...
import * as TourData from 'src/app/content/tour.device-based.json';
import { HelperService } from 'src/app/services/helper/helper.service';
const TourContent = (<any>TourData).data;

@Component({
  selector: 'oc-tour-device-based',
  templateUrl: './tour-device-based.component.html',
  styleUrls: ['./tour-device-based.component.css']
})
export class TourDeviceBasedComponent implements OnInit {
  @Input() headers;
