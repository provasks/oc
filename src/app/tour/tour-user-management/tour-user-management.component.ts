...
import * as TourData from 'src/app/content/tour.user-management.json';
import { HelperService } from 'src/app/services/helper/helper.service';
const TourContent = (<any>TourData).data;

@Component({
  selector: 'oc-tour-user-management',
  templateUrl: './tour-user-management.component.html',
  styleUrls: ['./tour-user-management.component.css']
})
export class TourUserManagementComponent implements OnInit {
  @Input() grid;
